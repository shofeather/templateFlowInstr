		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
				<div class="title pb-20">
					<h2 class="h3 mb-0">INSTR PERUM JASA TIRTA I</h2>
				</div>
				<div class="row">
					<div class="col-lg-4 col-md-12 mb-20">
						<div class="card-box height-100-p pd-20 min-height-200px">
							<div class="max-width-300 mx-auto">
								<img src="<?=base_url(); ?>assets/vendors/images/upgrade.svg" alt="" />
							</div>
							<div class="row pb-10">
									...
									<div class="card-box height-100-p widget-style3">
										<div class="d-flex flex-wrap">
											<div class="widget-data">
												<div class="weight-700 font-24 text-dark">9,41</div>
								...
								<div class="col-xl-12 col-lg-12 col-md-6 mb-20">
									<div class="card-box height-100-p widget-style3">
										<div class="d-flex flex-wrap">
											<div class="widget-data">
												<div class="weight-700 font-24 text-dark">13,13</div>
												<div class="font-14 text-secondary weight-500">
													VCC
												</div>
											</div>
								...
								<div class="col-xl-12 col-lg-12 col-md-6 mb-20">
									<div class="card-box height-100-p widget-style3">
										<div class="d-flex flex-wrap">
											<div class="widget-data">
												<div class="weight-700 font-24 text-dark">38,6</div>
												<div class="font-14 text-secondary weight-500">
													LOGGER
												</div>
											</div>
							...
							<div class="text-center">
								<div class="h5 mb-1">INSTR SENGGURUH</div>
								<div
									class="font-14 weight-500 max-width-200 mx-auto pb-20"
									data-color="#a6a6a7"
								>
									Latest Data : 12/01/2023
								</div>
								<a href="index-detail.html" class="btn btn-primary btn-lg">Details</a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-12 mb-20">
			...
			<div class="footer-wrap pd-20 mb-20 pt-20 card-box">
				INSTR FLOW &copy; 2023
				<a href="https://jasatirta1.co.id" target="_blank"
					>PERUM JASA TIRTA I</a
				>
			</div>
		</div>
